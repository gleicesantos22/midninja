import { r as t, c as e, h as i, H as r, g as s } from "./p-43f79dfb.js";
import { i as o, e as n } from "./p-ab62d96d.js";
import { i as a, g as l, c as p } from "./p-b9156af0.js";
var h =
  ...
  (c.exports = (function () {
    ...
    var b = (function () {
      function e(t, i) {
        (function (e, t) {
          ...
          y(this.element) &&
            f(this.element.rangeTouch) &&
            ((this.config = s({}, o, {}, i)), this.init());
      }
      return (
        (function (e, i, r) {
    ...
    function G(e) {
      $(e) || z(e)
        ...
        : j(e) && j(e.parentNode) && e.parentNode.removeChild(e);
    }
    ...
    const le = {
      ...
      pe = {
        ...
        pip: !(
          B.isIPhone ||
          (!N(K("video").webkitSetPresentationMode) &&
            (!document.pictureInPictureEnabled ||
              K("video").disablePictureInPicture))
        ),
    ...
    function ge() {
      this &&
        ...
        (this.eventListeners.forEach((e) => {
          const { element: t, type: i, callback: r, options: s } = e;
    ...
    function fe() {
      return new Promise((e) =>
        this.ready
          ? setTimeout(e, 0)
          : he.call(this, this.elements.container, "ready", e)
      ).then(() => {});
    }
    ...
    function xe(e) {
      return (
        !!(z(e) || (L(e) && e.includes(":"))) &&
        (z(e) ? e : e.split(":")).map(Number).every(M)
      );
    }
    ...
    const Se = {
      ...
      setup() {
        ...
        (e.options.speed = e.config.speed.options),
          H(this.config.ratio) || Pe.call(e),
          Object.defineProperty(e.media, "quality", {
            get() {
              const t = Se.getSources
                .call(e)
    ...
    const De = {
      ...
      createIcon(e, t) {
        ...
        return (
          ...
          a.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", n),
          o.appendChild(a),
          o
        );
      },
      ...
      createButton(e, t) {
        ...
        return (
          s.toggle
            ? (o.appendChild(
                De.createIcon.call(this, s.iconPressed, {
                  class: "icon--pressed",
                })
              ),
              o.appendChild(
                De.createIcon.call(this, s.icon, {
                  class: "icon--not-pressed",
                })
              ),
              o.appendChild(
                De.createLabel.call(this, s.labelPressed, {
                  class: "label--pressed",
                })
              ),
              o.appendChild(
                De.createLabel.call(this, s.label, {
                  class: "label--not-pressed",
                })
              ))
            : (o.appendChild(De.createIcon.call(this, s.icon)),
              o.appendChild(De.createLabel.call(this, s.label))),
          W(i, ee(this.config.selectors.buttons[r], i)),
          Y(o, i),
          "play" === r
            ? (z(this.elements.buttons[r]) || (this.elements.buttons[r] = []),
      ...
      createRange(e, t) {
        ...
        return (
          ...
          De.updateRangeFill.call(this, i),
          b.setup(i),
          i
        );
      },
      ...
      bindMenuItemShortcuts(e, t) {
        he.call(
          ...
          (i) => {
            ...
            if (!r && ["Space", "ArrowRight"].includes(i.key))
              De.showMenuPanel.call(this, t, !0);
            else {
              let t;
              "Space" !== i.key &&
                ("ArrowDown" === i.key || (r && "ArrowRight" === i.key)
                  ? ((t = e.nextElementSibling),
                    j(t) || (t = e.parentNode.firstElementChild))
                  : ((t = e.previousElementSibling),
                    j(t) || (t = e.parentNode.lastElementChild)),
                ne.call(this, t, !0));
            }
          },
          !1
        ),
          he.call(this, e, "keyup", (e) => {
      ...
      createMenuItem({
        ...
        (l.innerHTML = r),
          ...
          Object.defineProperty(n, "checked", {
            ...
            set(e) {
              e &&
                Array.from(n.parentNode.children)
                  .filter((e) => se(e, '[role="menuitemradio"]'))
                  .forEach((e) => e.setAttribute("aria-checked", "false")),
                n.setAttribute("aria-checked", e ? "true" : "false");
            },
          }),
          this.listeners.bind(
            n,
            ...
            (t) => {
              if (!R(t) || "Space" === t.key) {
                switch (
                  (t.preventDefault(), t.stopPropagation(), (n.checked = !0), i)
                ) {
                  case "language":
          ...
          De.bindMenuItemShortcuts.call(this, n, i),
          t.appendChild(n);
      },
      formatTime(e = 0, t = !1) {
      ...
      updateVolume() {
        this.supported.ui &&
          (j(this.elements.inputs.volume) &&
            De.setRange.call(
              this,
              this.elements.inputs.volume,
              this.muted ? 0 : this.volume
            ),
          j(this.elements.buttons.mute) &&
          ...
          switch (e.type) {
            ...
            case "seeked":
              (r = this.currentTime),
                (s = this.duration),
                (t =
                  0 === r || 0 === s || Number.isNaN(r) || Number.isNaN(s)
                    ? 0
                    : ((r / s) * 100).toFixed(2)),
                "timeupdate" === e.type &&
                  De.setRange.call(this, this.elements.inputs.seek, t);
              break;
            case "playing":
            case "progress":
      ...
      updateRangeFill(e) {
        ...
        if (j(t) && "range" === t.getAttribute("type")) {
          if (se(t, this.config.selectors.inputs.seek)) {
            ...
            t.setAttribute(
              "aria-valuetext",
              r.replace("{currentTime}", e).replace("{duration}", i)
            );
      ...
      updateSeekTooltip(e) {
        ...
        if (
          ...
          !j(this.elements.inputs.seek) ||
          !j(this.elements.display.seekTooltip) ||
          0 === this.duration
        )
          return;
        ...
        p
          ? (r.insertAdjacentHTML("afterbegin", `${p.label}<br>`),
            r.classList.add("plyr__tooltip--label"))
          : r.classList.remove("plyr__tooltip--label"),
          (r.style.left = `${a}%`),
          O(e) &&
      ...
      durationUpdate() {
        ...
        !e &&
          ...
          this.config.markers.enabled && De.setMarkers.call(this),
          De.updateSeekTooltip.call(this);
      },
      ...
      updateSetting(e, t, i) {
        ...
        if ("captions" === e) s = this.currentTrack;
          ...
          if (
            ((s = H(i) ? this[e] : i),
            H(s) && (s = this.config[e].default),
            !H(this.options[e]) && !this.options[e].includes(s))
          )
        ...
        if ((j(o) || (o = r && r.querySelector('[role="menu"]')), !j(o)))
          return;
        this.elements.settings.buttons[e].querySelector(
          `.${this.config.classNames.menu.value}`
        ).innerHTML = De.getLabel.call(this, e, s);
      ...
      setQualityMenu(e) {
        ...
        if (
          (De.toggleMenuButton.call(this, t, r),
          J(i),
          De.checkMenu.call(this),
          !r)
        )
          return;
        const s = (e) => {
      ...
      setCaptionsMenu() {
        ...
        const e = "captions",
          ...
          r = Boolean(i.length);
        if (
          (De.toggleMenuButton.call(this, e, r),
          J(t),
          De.checkMenu.call(this),
          !r)
        )
        ...
        const s = i.map((e, i) => ({
          ...
          badge:
            e.language && De.createBadge.call(this, e.language.toUpperCase()),
          list: t,
          type: "language",
        }));
        s.unshift({
          ...
          s.forEach(De.createMenuItem.bind(this)),
      ...
      setSpeedMenu() {
        ...
        De.toggleMenuButton.call(this, e, i),
          J(t),
          De.checkMenu.call(this),
          i &&
      ...
      checkMenu() {
        const { buttons: e } = this.elements.settings,
          t = !H(e) && Object.values(e).some((e) => !e.hidden);
      ...
      toggleMenu(e) {
        ...
        i.setAttribute("aria-expanded", s),
          te(t, !s),
          ie(this.elements.container, this.config.classNames.menu.open, s),
          s && R(e)
            ? De.focusFirstMenuItem.call(this, null, !0)
            : s || r || ne.call(this, i, R(e));
      },
      getMenuSize(e) {
      ...
      create(e) {
        ...
        return (
          ve(z(this.config.controls) ? this.config.controls : []).forEach(
            (a) => {
              if (
                ("restart" === a && p.appendChild(i.call(this, "restart", c)),
                "rewind" === a && p.appendChild(i.call(this, "rewind", c)),
                "play" === a && p.appendChild(i.call(this, "play", c)),
                "fast-forward" === a &&
                  p.appendChild(i.call(this, "fast-forward", c)),
                "progress" === a)
              ) {
                const t = K("div", {
                ...
                if (
                  ...
                  i.appendChild(r.call(this, "buffer")),
                  this.config.tooltips.seek)
                ) {
                  const e = K(
                    "span",
              ...
              if (
                ("current-time" === a &&
                  p.appendChild(o.call(this, "currentTime", c)),
                "duration" === a && p.appendChild(o.call(this, "duration", c)),
                "mute" === a || "volume" === a)
              ) {
              ...
              if (
                ("captions" === a && p.appendChild(i.call(this, "captions", c)),
                ...
                a.appendChild(n),
                  ...
                  this.config.settings.forEach((i) => {
                    const r = K(
                      "button",
                      W(ee(this.config.selectors.buttons.settings), {
                        type: "button",
                    ...
                    c.appendChild(
                      ...
                      o.appendChild(p),
                      (this.elements.settings.buttons[i] = r),
                      (this.elements.settings.panels[i] = p);
                  }),
                  s.appendChild(o),
                  r.appendChild(s),
                  p.appendChild(r),
              ...
              if (
                ("pip" === a && pe.pip && p.appendChild(i.call(this, "pip", c)),
                "airplay" === a &&
                  pe.airplay &&
                  p.appendChild(i.call(this, "airplay", c)),
                "download" === a)
              ) {
                const e = W({}, c, {
                  element: "a",
              ...
              "fullscreen" === a &&
                p.appendChild(i.call(this, "fullscreen", c));
            }
          ),
          this.isHTML5 && a.call(this, Se.getQualityOptions.call(this)),
          n.call(this),
          p
        );
      },
      inject() {
        ...
        if (
          ...
          j(this.config.controls) || L(this.config.controls)
            ? (e = this.config.controls)
            : ((e = De.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
          ...
          j(i) || (i = this.elements.container),
          i[j(e) ? "insertAdjacentElement" : "insertAdjacentHTML"](
            "afterbegin",
            e
          ),
          j(this.elements.controls) || De.findElements.call(this),
    ...
    const Ve = {
        setup() {
          ...
          if (
            ...
            return void (
              ...
              De.setCaptionsMenu.call(this)
            );
          var e, t;
          if (
            (j(this.elements.captions) ||
              ((this.elements.captions = K(
                "div",
              ...
              j(e) && j(t) && t.parentNode.insertBefore(e, t.nextSibling)),
            B.isIE && window.URL)
          ) {
          ...
          if (
            (I(s) || ({ active: s } = this.config.captions),
            ...
            e
              ...
              .forEach((e) => {
                this.debug.log("Track added", e),
                  ...
                  he.call(this, e, "cuechange", () => Ve.updateCues.call(this));
              }),
            ((o && this.language !== i) || !e.includes(s)) &&
              (Ve.setLanguage.call(this, i), Ve.toggle.call(this, t && o)),
            this.elements &&
              ie(
        ...
        toggle(e, t = !0) {
          ...
          if (s !== i) {
            ...
            this.elements.buttons.captions &&
              ...
              ie(this.elements.container, r, s),
              (this.captions.toggled = s),
              De.updateSetting.call(this, "captions"),
              ye.call(
                this,
                this.media,
          ...
          setTimeout(() => {
            s &&
              ...
              this.captions.currentTrackNode &&
        ...
        findTrack(e, t = !1) {
          ...
          let o;
          return (
            e.every((e) => ((o = s.find((t) => t.language === e)), !o)),
            o || (t ? s[0] : void 0)
          );
        },
        getCurrentTrack() {
        ...
        getLabel(e) {
          ...
          return (
            !F(t) &&
              pe.textTracks &&
              this.captions.toggled &&
              (t = Ve.getCurrentTrack.call(this)),
            F(t)
              ? H(t.label)
                ? H(t.language)
                  ? ze.get("enabled", this.config)
                  : e.language.toUpperCase()
                : t.label
              : ze.get("disabled", this.config)
          );
        },
        updateCues(e) {
          if (!this.supported.ui) return;
          if (!j(this.elements.captions))
    ...
    class Xe {
        ...
        e(this, "onChange", () => {
          ...
          e(this, "toggleFallback", (e = !1) => {
            if (
              ...
              e
                ? ((this.cleanupViewport = !r), r || (t.content += `,${i}`))
          ...
          e(this, "trapFocus", (e) => {
            ...
            const t = document.activeElement,
              ...
              s = i[i.length - 1];
            t !== s || e.shiftKey
              ? t === r && e.shiftKey && (s.focus(), e.preventDefault())
          ...
          e(this, "enter", () => {
            this.enabled &&
              (B.isIos && this.player.config.fullscreen.iosNative
                ? this.player.isVimeo
          ...
          e(this, "exit", () => {
            if (this.enabled)
              if (B.isIos && this.player.config.fullscreen.iosNative)
          ...
          he.call(
            ...
            (e) => {
              if (
                j(this.player.elements.controls) &&
                this.player.elements.controls.contains(e.target)
              )
                return;
              const t = this.player.elements.container.querySelector(
                "presto-search-bar-ui"
              );
              (j(t) && t.contains(e.target)) ||
                this.player.listeners.proxy(e, this.toggle, "fullscreen");
            }
          ),
          he.call(this, this.player.elements.container, "keydown", (e) =>
            this.trapFocus(e)
          ),
          this.update();
      }
      ...
      static get prefix() {
        ...
        return (
          ["webkit", "moz", "ms"].some(
            (t) =>
              !(
                (!N(document[`${t}ExitFullscreen`]) &&
                  !N(document[`${t}CancelFullScreen`])) ||
                ((e = t), 0)
              )
          ),
          e
      ...
      get target() {
        return B.isIos && this.player.config.fullscreen.iosNative
          ? this.player.media
    ...
    const Je = {
      ...
      build() {
        ...
        j(this.elements.controls) ||
          (De.inject.call(this), this.listeners.controls()),
          ...
          (this.quality = null),
          (this.speed = null),
          De.updateVolume.call(this),
          De.timeUpdate.call(this),
          De.durationUpdate.call(this),
          Je.checkPlaying.call(this),
          ie(
            this.elements.container,
            this.config.classNames.pip.supported,
            pe.pip && this.isHTML5 && this.isVideo
          ),
          ie(
            this.elements.container,
            this.config.classNames.airplay.supported,
            pe.airplay && this.isHTML5
          ),
          ie(this.elements.container, this.config.classNames.isIos, B.isIos),
          ie(
            this.elements.container,
          ...
          this.config.duration && De.durationUpdate.call(this),
          this.config.mediaMetadata && De.setMediaMetadata.call(this);
      },
      setTitle() {
        ...
        ie(
          ...
          Array.from(this.elements.buttons.play || []).forEach((e) => {
            Object.assign(e, {
              ...
              e.setAttribute(
                "aria-label",
                ze.get(this.playing ? "pause" : "play", this.config)
              );
          }),
      ...
      migrateStyles() {
        Object.values({ ...this.media.style })
          .filter((e) => !H(e) && L(e) && e.startsWith("--plyr"))
          .forEach((e) => {
      ...
      constructor(t) {
        e(this, "firstTouch", () => {
          ...
          e(this, "setTabFocus", (e) => {
            const { player: t } = this,
              { elements: i } = t,
              { key: r, type: s, timeStamp: o } = e;
            if ((clearTimeout(this.focusTimer), "keydown" === s && "Tab" !== r))
              return;
          ...
          e(this, "container", () => {
            const { player: e } = this,
              { config: t, elements: i, timers: r } = e;
            !t.keyboard.global &&
              t.keyboard.focused &&
              he.call(e, i.container, "keydown keyup", this.handleKey, !1),
              he.call(
                e,
                i.container,
                ...
                (t) => {
                  ...
                  ["touchstart", "touchmove", "mousemove"].includes(t.type) &&
                    (Je.toggleControls.call(e, !0), (o = e.touch ? 3e3 : 2e3)),
            ...
            const s = () => {
                ...
                const [n, l] = [
                  ...
                  p = n / l > s / o;
                a
                  ? ((t.style.width = p ? "auto" : "100%"),
                    (t.style.height = p ? "100%" : "auto"))
                  : ((t.style.maxWidth = p ? (l / o) * s + "px" : null),
                    (t.style.margin = p ? "0 auto" : null));
              },
              o = () => {
            ...
            he.call(e, i.container, "enterfullscreen exitfullscreen", (t) => {
              ...
              r === i.container &&
                ((!e.isEmbed && H(e.config.ratio)) ||
                  (s(),
                  ("enterfullscreen" === t.type ? he : ue).call(
                    e,
                    window,
                    "resize",
                    o
          ...
          e(this, "media", () => {
            const { player: e } = this,
              { elements: t } = e;
            if (
              (he.call(e, e.media, "timeupdate seeking seeked", (t) =>
                De.timeUpdate.call(e, t)
              ),
              he.call(
                e,
                e.media,
                "durationchange loadeddata loadedmetadata",
                (t) => De.durationUpdate.call(e, t)
              ),
              he.call(e, e.media, "ended", () => {
                e.isHTML5 &&
                  e.isVideo &&
                  e.config.resetOnEnd &&
                  (e.restart(), e.pause());
              }),
              he.call(e, e.media, "progress playing seeking seeked", (t) =>
                De.updateProgress.call(e, t)
              ),
              he.call(e, e.media, "volumechange", (t) =>
                De.updateVolume.call(e, t)
              ),
              he.call(
                e,
                e.media,
              ...
              he.call(e, e.media, "waiting canplay seeked playing", (t) =>
              ...
              he.call(e, t.container, "click", (r) => {
                ([t.container, i].includes(r.target) || i.contains(r.target)) &&
            ...
            e.supported.ui &&
              ...
              he.call(e, e.media, "volumechange", () => {
                e.storage.set({
                  volume: e.volume,
                  muted: e.muted,
                });
            ...
            he.call(e, e.media, i, (i) => {
              let { detail: r = {} } = i;
              "error" === i.type && (r = e.media.error),
                ye.call(e, t.container, i.type, !0, r);
            });
          }),
          e(this, "proxy", (e, t, i) => {
            const { player: r } = this,
              s = r.config.listeners[i];
            let o = !0;
            N(s) && (o = s.call(r, e)), !1 !== o && N(t) && t.call(r, e);
          }),
          e(this, "bind", (e, t, i, r, s = !0) => {
            const { player: o } = this,
              a = o.config.listeners[r],
              n = N(a);
                  ...
                  ["Space", "Enter"].includes(t.key) &&
                    ("Enter" !== t.key
                      ? (t.preventDefault(),
                        t.stopPropagation(),
                        De.toggleMenu.call(e, t))
                      : De.focusFirstMenuItem.call(e, null, !0));
                },
                null,
                !1
              ),
              ...
              this.bind(
                ...
                (t) => {
                  const i = t.currentTarget,
                    r = "play-on-seeked";
                  if (R(t) && !["ArrowLeft", "ArrowRight"].includes(t.key))
                    return;
                  e.lastSeekTime = Date.now();
                  const s = i.hasAttribute(r),
                    o = ["mouseup", "touchend", "keyup"].includes(t.type);
                  s && o
                    ? (i.removeAttribute(r), be(e.play()))
                    : !o && e.playing && (i.setAttribute(r, ""), e.pause());
                }
              ),
              B.isIos)
            ) {
            ...
            this.bind(
              ...
              (t) => {
                ...
                H(r) && (r = i.value),
                  ...
                  (e.currentTime = (r / i.max) * e.duration);
              },
              "seek"
            ),
              this.bind(t.progress, "mouseenter mouseleave mousemove", (t) =>
                De.updateSeekTooltip.call(e, t)
              ),
              ...
              B.isWebkit &&
                Array.from(oe.call(e, 'input[type="range"]')).forEach((t) => {
                  this.bind(t, "input", (t) =>
                    De.updateRangeFill.call(e, t.target)
                  );
                }),
              e.config.toggleInvert &&
                !j(t.display.duration) &&
                this.bind(t.display.currentTime, "click", () => {
                  0 !== e.currentTime &&
                    ((e.config.invertTime = !e.config.invertTime),
                    De.timeUpdate.call(e));
                }),
              this.bind(
                t.inputs.volume,
                i,
        ...
        if (!(o || a || n || l) && r)
          if (p) {
            ...
            if (j(s)) {
              ...
              if ("Space" === e.key && se(s, 'button, [role^="menuitem"]'))
                return;
            }
            switch (
              ([
          ...
          e.exports = (function () {
            ...
            function s(e, t) {
              ...
              for (
                ...
                (o = e[l]), (a = i[o]) ? s(o, a) : (r[o] = r[o] || []).push(s);
            }
    ...
    const rt = {
      ...
      ready() {
        const e = this,
          t = e.config.vimeo,
          { premium: i, referrerPolicy: r, ...s } = t;
        ...
        if (
          ...
          H(r) || d.setAttribute("referrerPolicy", r),
          i || !t.customControls)
        )
          d.setAttribute("data-poster", e.poster), (e.media = Z(d, e.media));
        else {
          const t = K("div", {
        ...
        t.customControls ||
          je(Ee(e.config.urls.vimeo.api, h)).then((t) => {
            !H(t) &&
              t.thumbnail_url &&
        ...
        Object.defineProperty(e.media, "currentTime", {
          get: () => u,
          set(t) {
            const { embed: i, media: r, paused: s, volume: o } = e,
              a = s && !i.hasPlayed;
            (r.seeking = !0),
              ye.call(e, r, "seeking"),
    ...
    const at = {
        setup() {
          if (
            ...
            E(window.YT) && N(window.YT.Player))
          )
            at.ready.call(this);
          else {
        ...
        getTitle(e) {
          je(Ee(this.config.urls.youtube.api, e))
            .then((e) => {
              if (E(e)) {
                const { title: t, height: i, width: r } = e;
                (this.config.title = t),
                  Je.setTitle.call(this),
                  (this.embed.ratio = Ce(r, i));
              }
              Pe.call(this);
            })
            .catch(() => {
        ...
        setup() {
          this.media
            ? (ie(
              ...
              this.isVideo &&
                ((this.elements.wrapper = K("div", {
                  class: this.config.classNames.video,
                })),
                Q(this.media, this.elements.wrapper),
                (this.elements.poster = K("div", {
              ...
              this.isHTML5
                ...
                : this.isYouTube
                ? at.setup.call(this)
                : this.isVimeo && rt.setup.call(this))
    ...
    class lt {
      ...
      get tagUrl() {
        ...
        return D(e.tagUrl)
          ? e.tagUrl
          : `https://go.aniview.com/api/adserver6/vast/?${qe({
      ...
      constructor(t) {
        e(this, "load", () => {
          ...
          e(this, "startMove", (e) => {
            if (
              ...
              if ("touchmove" === e.type)
                ...
                (this.seekTime = this.player.media.duration * (s / 100)),
          ...
          e(this, "startScrubbing", (e) => {
            (S(e.button) || !1 === e.button || 0 === e.button) &&
              ((this.mouseDown = !0),
              this.player.media.duration &&
          ...
          e(this, "endScrubbing", () => {
            (this.mouseDown = !1),
              ...
              Math.ceil(this.player.media.currentTime)
                ...
                : me.call(this.player, this.player.media, "timeupdate", () => {
          ...
          e(this, "render", () => {
            ...
            (this.elements.thumb.time = K("span", {}, "00:00")),
              e.appendChild(this.elements.thumb.time),
              this.elements.thumb.imageContainer.appendChild(e),
              j(this.player.elements.progress) &&
                this.player.elements.progress.appendChild(
                  this.elements.thumb.container
                ),
              (this.elements.scrubbing.container = K("div", {
                class:
                  this.player.config.classNames.previewThumbnails
                    .scrubbingContainer,
              })),
          ...
          e(this, "showImage", (e, t, i, r, s, o = !0) => {
            this.player.debug.log(
              `Showing thumb: ${s}. num: ${r}. qual: ${i}. newimg: ${o}`
            ),
          ...
          e(this, "setThumbContainerPos", () => {
            const e = this.player.elements.progress.getBoundingClientRect(),
              ...
              a = pt(o, r, s);
            (i.style.left = `${a}px`),
              i.style.setProperty("--preview-arrow-offset", o - a + "px");
          }),
            ...
            this.destroy.call(
              ...
              () => {
                (this.options.quality = []),
                  G(this.media),
                  (this.media = null),
                  j(this.elements.container) &&
                    this.elements.container.removeAttribute("class");
                const { sources: t, type: i } = e,
                  [{ provider: r = We.html5, src: s }] = t,
                  o = "html5" === r ? i : "div",
                  a =
                    "html5" === r
                      ? {}
                ...
                Object.assign(this, {
                  ...
                  I(e.autoplay) && (this.config.autoplay = e.autoplay),
                  this.isHTML5 &&
                    (this.config.crossorigin &&
                      this.media.setAttribute("crossorigin", ""),
                    this.config.autoplay &&
                      this.media.setAttribute("autoplay", ""),
                    H(e.poster) || (this.poster = e.poster),
                  ...
                  this.isHTML5 && ut.insertElements.call(this, "source", t),
                  (this.config.title = e.title),
                  nt.setup.call(this),
                  this.isHTML5 &&
                    Object.keys(e).includes("tracks") &&
                    ut.insertElements.call(this, "track", e.tracks),
                  (this.isHTML5 || (this.isEmbed && !this.supported.ui)) &&
                    Je.build.call(this),
                  this.isHTML5 && this.media.load(),
                  H(e.previewThumbnails) ||
                    (Object.assign(
                    ...
                    this.config.previewThumbnails.enabled &&
                      (this.previewThumbnails = new ht(this))),
    ...
    class mt {
      constructor(t, i) {
        if (
          ...
          e(this, "pause", () =>
            this.playing && N(this.media.pause) ? this.media.pause() : null
          ),
          e(this, "togglePlay", (e) =>
            (I(e) ? e : !this.playing) ? this.play() : this.pause()
          ),
          e(this, "stop", () => {
            this.isHTML5
              ? (this.pause(), this.restart())
              : N(this.media.stop) && this.media.stop();
          }),
          e(this, "restart", () => {
            this.currentTime = 0;
          }),
            ...
            if (this.supported.ui && !this.isAudio) {
              ...
              if (
                (r &&
                  z(this.config.controls) &&
                  this.config.controls.includes("settings") &&
                  !H(this.config.settings) &&
                  De.toggleMenu.call(this, !1),
                r !== t)
              ) {
          ...
          e(this, "supports", (e) => pe.mime.call(this, e)),
          (this.timers = {}),
          (this.ready = !1),
          (this.loading = !1),
          (this.failed = !1),
          ...
          this.debug.log("Support", pe),
          S(this.media) || !j(this.media))
        )
        ...
        switch (s) {
          case "div":
            ...
            if (H(this.provider) || !Object.values(We).includes(this.provider))
      ...
      set volume(e) {
        let t = e;
        L(t) && (t = Number(t)),
          M(t) || (t = this.storage.get("volume")),
          M(t) || ({ volume: t } = this.config),
          t > 1 && (t = 1),
          t < 0 && (t = 0),
          (this.config.volume = t),
          (this.media.volume = t),
          !H(e) && this.muted && t > 0 && (this.muted = !1);
      }
      get volume() {
      ...
      set muted(e) {
        let t = e;
        I(t) || (t = this.storage.get("muted")),
          I(t) || (t = this.config.muted),
          (this.config.muted = t),
          (this.media.muted = t);
      }
      get muted() {
      ...
      set speed(e) {
        let t = null;
        M(e) && (t = e),
          M(t) || (t = this.storage.get("speed")),
          M(t) || (t = this.config.speed.selected);
      ...
      set ratio(e) {
        this.isVideo
          ? L(e) && xe(e)
            ? ((this.config.ratio = Te(e)), Pe.call(this))
      ...
      set pip(e) {
        ...
        N(this.media.webkitSetPresentationMode) &&
          this.media.webkitSetPresentationMode(t ? Ue : "inline"),
          N(this.media.requestPictureInPicture) &&
            (!this.pip && t
      ...
      get pip() {
        return pe.pip
          ? H(this.media.webkitPresentationMode)
            ? this.media === document.pictureInPictureElement
            : this.media.webkitPresentationMode === Ue
          : null;
      }
...
function v(e, t = !1) {
  if (!e?.config?.save_player_position || e?.config?.mutedPreview?.enabled)
    return;
  let i = m(e);
  return (
    e.hls && i >= 0 && e.hls.startLoad(i),
    e.duration && (i = Math.min(i, e.duration)),
    !i || i < 1
      ? 0
      : ((e.currentTime = i),
        e?.isVimeo &&
...
function _(e) {
  0 !== e.currentTime &&
    e?.config?.save_player_position &&
    localStorage.setItem(`player-progress-${y(e)}`, e.currentTime);
}
...
function k({ position: e = 0, name: t = "" }) {
...
function j(e) {
  ...
  if (
    ...
    "html5" === i.provider && !i.duration)
  )
    return void i.on("loadedmetadata", j);
  if (!t || !Object.keys(t).length) return;
  (r = jQuery(i.elements.container)
    .closest(".presto-player__wrapper")
    .find(".plyr")),
    (d = jQuery(i.elements.controls));
  let f = d.find(".plyr__time");
  (f = f.length ? f : d.find(".plyr__progress__container")),
    (n = r.find('[data-plyr="chapters"]')),
    n.length || (n = jQuery(x).insertAfter(f)),
    (o = r.find(".presto-player-toc__wrapper")),
    o.length || (o = jQuery($).appendTo(r)),
    (l = o.find("[data-player-toc-cover]")),
    (a = o.find("[data-player-toc]")),
    (s = r.find(".plyr__progress__container"));
  ...
  function v() {
    ...
    let e = Object.keys(t)
        ...
        .map((e) => parseInt(e, 10)),
      r = Math.max(...e);
    c && c.removeClass("is-highlighted"),
      jQuery(u[r || 0]).addClass("is-highlighted");
  }
  ...
  function w(e) {
    void 0 !== typeof e
      ? o.toggleClass("is-showing", e)
      : o.toggleClass("is-showing");
  }
  (p = jQuery('<div class="presto-player__chapter-markers"></div>').appendTo(
    b
  )),
    (function () {
      let e = 0;
      a.find(".presto-player-toc__chapter").length ||
        (Object.keys(t).forEach((r) => {
          ...
          o.data("presto-player-timestamp", r),
            (u[r] = o),
            o.on("click", () => {
              (i.currentTime = parseFloat(r)),
                i.playing ||
                  (i.play(),
                  i.once("playing", () => {
                    setTimeout(() => {
    ...
    (y = window.setInterval(function () {
      g++,
        i.duration && (_(), window.clearInterval(y)),
        g > 50 && window.clearInterval(y);
    }, 100)),
    l.off("click"),
    l.on("click", () => w(!1)),
    a.off("mouseleave"),
...
function S(e) {
  "undefined" != typeof jQuery &&
    ((z = e),
    jQuery(z.elements.container).closest(".presto-player__wrapper"),
    z.on("ready", j),
    z.on("controlshidden", P),
    z.on("controlsshown", O));
}
...
function C() {
  window?.gtag &&
    (wp.hooks.addAction("presto.playerPlay", "presto-player", M),
    wp.hooks.addAction("presto.playerPause", "presto-player", I),
    wp.hooks.addAction("presto.playerReady", "presto-player", E),
    wp.hooks.addAction("presto.playerTimeUpdate", "presto-player", R));
}
...
function M(e) {
  e?.config?.hasPlayed ||
    ((e.config.hasPlayed = !0), window?.gtag("event", "Play", A(e)));
}
...
function E(e) {
  e?.config?.hasLoaded ||
    ((e.config.hasLoaded = !0), window?.gtag("event", "Player Load", A(e)));
}
let L,
  N = {
    25: !1,
...
function R(e) {
  ...
  Object.keys(N).forEach((i) => {
    !N[i] &&
      t >= parseInt(i) &&
      ((N[i] = !0), window?.gtag("event", `${i} Percent Played`, A(e)));
  });
}
...
function D(e) {
  (L = e),
    L.config.analytics &&
      window?.wp?.hooks &&
      (wp.hooks.hasAction("presto.nonceRefreshed", F) ||
        wp.hooks.addAction("presto.nonceRefreshed", F, (e) => {
          q = e;
        }),
      wp.hooks.hasAction("presto.playerPlay", F) ||
        wp.hooks.addAction("presto.playerPlay", F, V),
      wp.hooks.hasAction("presto.playerEnded", F) ||
        wp.hooks.addAction("presto.playerEnded", F, V),
      wp.hooks.hasAction("presto.playerHidden", F) ||
        wp.hooks.addAction("presto.playerHidden", F, V),
      wp.hooks.hasAction("presto.playerPause", F) ||
        wp.hooks.addAction("presto.playerPause", F, V),
      wp.hooks.hasAction("presto.playerSeeked", F) ||
        wp.hooks.addAction("presto.playerSeeked", F, V));
}

function U(e) {
  return (
    e.currentTime > B && (B = e.currentTime),
    e.currentTime >= e.duration && (B = e.duration),
    {
...
function H(e) {
  if (!q) return;
  let t = new FormData();
  t.append("action", "presto_player_progress"),
    t.append("duration", e?.video_current_time),
    t.append("video_id", L?.config?.id),
    t.append("nonce", q),
    window?.prestoPlayer?.debug_navigator
      ? "undefined" != typeof jQuery &&
        jQuery.ajax({
          type: "POST",
...
const Y = (e) => {
  e.on("ready", () => {
    e?.config?.logo &&
      ...
      (e.isAudio ||
        (jQuery(
          `<img src="${e?.config?.logo}" class="presto-player__logo is-bottom-right" part="logo">`
        ).insertBefore(e?.elements?.controls),
        (e.config.logo_added = !0)));
  });
};
...
const tt = (e) => {
  ...
  (null ===
    (i =
      null ===
        (t = null === window || void 0 === window ? void 0 : window.wp) ||
      void 0 === t
        ? void 0
        : t.hooks) || void 0 === i
    ? void 0
    : i.hasAction("presto.nonceRefreshed", G)) ||
    window.wp.hooks.addAction("presto.nonceRefreshed", G, (e) => {
      Z = e;
    }),
    null === window ||
      void 0 === window ||
      window.wp.hooks.addAction("presto.playerTimeUpdate", "presto-player", s),
    null === window ||
      void 0 === window ||
      window.wp.hooks.addAction("presto.playerEnded", "presto-player", (e) =>
        s(e, 100)
      );
  let r = {
    0: !1,
  ...
  function s(e, t = null) {
    ...
    Z &&
      (null === (i = null == e ? void 0 : e.config) || void 0 === i
        ? void 0
        : i.ajaxProgress) &&
      (t || (t = (parseFloat(e.currentTime) / parseFloat(e.duration)) * 100),
      (e.watched = e.watched || {}),
      Object.keys(r).forEach((i) => {
        ...
        if (!e.watched[h] && t >= h) {
          ...
          let t = new FormData();
          if (
            (t.append("action", "presto_player_progress_percent"),
            t.append(
              "id",
            ...
            t.append("percent", h.toString()),
            t.append("visit_time", X.toString()),
            t.append("nonce", Z),
            (null ===
              (s =
                null === window || void 0 === window
                  ? void 0
                  : window.prestoPlayer) || void 0 === s
              ? void 0
              : s.debug) && console.log(`${h} percent watched.`),
            null ===
              (o =
                null === window || void 0 === window
                  ? void 0
                  : window.prestoPlayer) || void 0 === o
              ? void 0
              : o.debug_navigator)
          )
            window.jQuery.ajax({
              ...
              data: {
                ...
                id:
                  null === (d = null == e ? void 0 : e.config) || void 0 === d
                    ? void 0
                    : d.id,
                visit_time: X,
                percent: h,
            ...
            let i = navigator.sendBeacon(
              null ===
                (a =
                  null === window || void 0 === window
                    ? void 0
                    : window.prestoPlayer) || void 0 === a
                ? void 0
                : a.ajaxurl,
              t
            );
            (null ===
              (n =
                null === window || void 0 === window
                  ? void 0
                  : window.prestoPlayer) || void 0 === n
              ? void 0
              : n.debug) &&
              (i
                ? console.log("Successfully queued progress:", {
                    id:
                      null === (l = null == e ? void 0 : e.config) ||
                      void 0 === l
                        ? void 0
                        : l.id,
                    percent: h,
...
const st = (e) => {
    var t, i;
    (e.config.analytics || e.config.automations) &&
      (null ===
        (i =
          null ===
            (t = null === window || void 0 === window ? void 0 : window.wp) ||
          void 0 === t
            ...
            : t.hooks) ||
        void 0 === i ||
        i.addAction("presto.playerPlaying", "presto-player", () => {
          null === window ||
            void 0 === window ||
            ...
            et ||
              ...
              fetch(
                ...
                .then(({ data: e }) => {
                  ...
                  null === window ||
                    void 0 === window ||
                    window.wp.hooks.doAction("presto.nonceRefreshed", t),
                    (et = !0);
                })
                .catch(function (e) {
  ...
  nt = async (e) => {
    if ("undefined" != typeof jQuery) {
      if ("ResizeObserver" in window == 0) {
        const e = await import("./p-6bd72be5.js");
      ...
      e?.elements?.container?.getRootNode()?.firstChild &&
        (t.observe(e?.elements?.container?.getRootNode()?.firstChild),
        e &&
          e.on("playing", () => {
            const t = e?.elements?.container
              ?.getRootNode()
              .firstChild.getBoundingClientRect();
            jQuery(e?.elements?.container?.getRootNode())
              .find(".plyr__menu__container")
              .css({
...
function at(e, t = {}) {
  const i =
      window?.parent?.prestoPlayer?.plugin_url ||
    ...
    r = {
      ...
      ...(i
        ? {
            iconUrl: `${i}img/${
              t?.preset?.skin ? t.preset.skin : "default"
            }.svg`,
          }
        : {}),
      chapters: t?.chapters || [],
  ...
  return (
    ...
    void 0 !== window.llms &&
      !0 === prestoPlayer?.lifter?.isLesson &&
    ...
    J(s),
    S(s),
    window?.prestoPlayer?.isAdmin || (st(s), tt(r), u(s), Q(s)),
    s
  );
}
const lt = ({ config: e, selector: t, src: i, preload: r }) =>
    i && a(i)
      ? t && t.canPlayType("application/vnd.apple.mpegurl") && o()
        ? pt({
            config: e,
            selector: t,
          })
        : import("./p-e1488dad.js").then((s) =>
            (0, s.default)({
              config: e,
              selector: t,
              src: i,
  ...
  ct = ({ src: e, el: t, preload: i, currentTime: r }) => {
    if (
      (!t || !t.getAttribute("hls_loaded")) &&
      ["metadata", "none"].includes(i) &&
      a(e)
    ) {
      if (r > 0)
        return (
          (t.style.height = null),
          (t.style.paddingBottom = null),
          void t.setAttribute("hls_loaded", "1")
        );
  ...
  dt = ({
    ...
    if (!a.match(/iPad/i) && !a.match(/iPhone/i)) {
      (e.config.mutedPreview.enabled = t),
        (e.muted = t),
        (e.loop = t),
        (e.config.ajaxProgress = !t && r),
        (e.config.save_player_position = !t && s);
      try {
...
function ut({
  ...
  const b = ["settings"],
    ...
    _ = [
      ...
      (t) => ((null == e ? void 0 : e[t]) || b.includes(t)) && !v.includes(t)
    );
  let w = Object.assign(
    Object.assign(
      Object.assign(
          ...
          Object.assign(
            {
              ...
              mutedPreview: {
                enabled:
                  null === (y = null == n ? void 0 : n.mutedPreview) ||
                  void 0 === y
                    ? void 0
                    : y.enabled,
              },
  ...
  return (
    (null === (f = null === window || void 0 === window ? void 0 : window.wp) ||
    void 0 === f
      ? void 0
      : f.hooks) &&
...
const yt =
  ...
  gt = class {
    constructor(i) {
      t(this, i),
        (this.loaded = e(this, "loaded", 7)),
        (this.currentMediaPlayer = e(this, "currentMediaPlayer", 7)),
        (this.playerReady = e(this, "playerReady", 7)),
        (this.playedMedia = e(this, "playedMedia", 7)),
        (this.pausedMedia = e(this, "pausedMedia", 7)),
        (this.endedMedia = e(this, "endedMedia", 7)),
        (this.components = {
          cta: null,
          email: null,
          overlays: null,
        ...
        (this.video_id = void 0),
        (this.iconUrl = void 0),
        (this.src = void 0),
        (this.bunny = void 0),
        (this.branding = void 0),
        (this.config = void 0),
        (this.preset = void 0),
        (this.chapters = void 0),
        (this.overlays = void 0),
        (this.blockAttributes = void 0),
        (this.tracks = void 0),
        (this.analytics = void 0),
        (this.automations = void 0),
        (this.provider = void 0),
        (this.provider_video_id = void 0),
        (this.actionBar = void 0),
        (this.youtube = void 0),
        (this.type = void 0),
        (this.autoplay = void 0),
        (this.preload = void 0),
        (this.poster = void 0),
        (this.playsinline = void 0),
        (this.isAdmin = !1),
        (this.direction = void 0),
        (this.css = void 0),
        (this.currentTime = void 0),
        (this.mediaTitle = void 0),
        (this.classes = void 0),
        (this.videoAttributes = void 0),
        (this.audioAttributes = void 0),
        (this.search = void 0),
        (this.markers = void 0),
        (this.player = void 0),
        (this.playerEl = void 0),
        (this.shouldLazyLoad = void 0),
        (this.mutedPreview = void 0),
        (this.duration = void 0),
        (this.isSticky = void 0),
        (this.videoHeight = void 0),
        (this.playClass = void 0),
        (this.previouslyPlaying = !1),
        (this.ctaActive = !1),
        (this.emailActive = !1),
        (this.actionBarActive = !1),
        (this.ready = void 0);
    }
    async play(e = !1) {
      (this.shouldLazyLoad = !1),
        e && (this.mutedPreview = !1),
        this.player.play();
    }
    async goToAndPlay(e) {
    ...
    async handleCurrentTimeChange(e) {
      this.player &&
        ...
        this.player.embed && !this.player.playing
    ...
    handleStickyChange() {
      l(this.el).forEach((e) => {
        var t;
        null === (t = null == e ? void 0 : e.classList) ||
          void 0 === t ||
          t.toggle("presto-sticky-parent", this.isSticky);
      });
    }
    getConfig() {
    ...
    handlePlayerElementChange() {
      ...
      ct({
        ...
        preload: this.preload,
        currentTime:
          null === (e = null == this ? void 0 : this.player) || void 0 === e
            ? void 0
            : e.currentTime,
      });
    }
      ...
      this.player &&
          ...
          this.player.once("timeupdate", () => {
            ...
            (this.player.loop =
              ...
              this.player.toggleCaptions(
                null === (t = null == this ? void 0 : this.preset) ||
                  void 0 === t
                  ? void 0
                  : t.captions_enabled
              );
        ...
        (null ===
          (s =
            null ===
              (r =
                null === (i = this.originalConfig) || void 0 === i
                  ? void 0
                  : i.blockAttributes) || void 0 === r
              ? void 0
              : r.mutedPreview) || void 0 === s
          ? void 0
          : s.enabled) &&
          dt({
            player: this.player,
            ...
            captions: !!(null ===
              (a =
                null === (o = this.blockAttributes) || void 0 === o
                  ? void 0
                  : o.mutedPreview) || void 0 === a
              ? void 0
              : a.captions),
            progress:
              null === (n = this.originalConfig) || void 0 === n
                ? void 0
                : n.ajaxProgress,
            savePosition:
              null === (l = this.originalConfig) || void 0 === l
                ? void 0
                : l.save_player_position,
            onPlay: () => this.play(),
          }));
    }
    onPlayerReady() {
      ...
      !!r.match(/iPad/i) ||
        ...
        (this.mutedPreview =
          null ===
            (t =
              null === (e = this.blockAttributes) || void 0 === e
                ? void 0
                : e.mutedPreview) || void 0 === t
            ? void 0
            : t.enabled),
        ...
        this.player.on(
          "playing",
          (e) =>
            !this.mutedPreview && this.currentMediaPlayer.emit(e.detail.plyr)
        ),
    ...
    componentWillLoad() {
      ...
      r &&
        r.classList &&
        r.classList.contains("presto-iframe-fallback-container") &&
        r.remove(),
        ...
        (this.i18n =
          ...
          (null ===
            (i =
              null === window || void 0 === window
                ? void 0
                : window.prestoPlayerAdmin) || void 0 === i
            ? void 0
            : i.i18n)),
        this.originalConfig || (this.originalConfig = this.getConfig()),
    ...
    renderSkins() {
      var e, t, r;
      return "modern" ===
        (null === (e = this.preset) || void 0 === e ? void 0 : e.skin)
        ? i("presto-modern-skin", null)
        : "business" ===
          (null === (t = this.preset) || void 0 === t ? void 0 : t.skin)
        ? i("presto-business-skin", null)
        : "stacked" ===
          (null === (r = this.preset) || void 0 === r ? void 0 : r.skin)
        ? i("presto-stacked-skin", null)
        : void 0;
    }
    async onReload(e) {
    ...
    playVideoOnlyInViewport() {
      ...
      !this.isAdmin &&
        (null === (e = this.preset) || void 0 === e
          ? void 0
          : e.play_video_viewport) &&
        this.player &&
        ("visible" === document.visibilityState
          ? this.observer.observe(this.el)
          : (this.player.playing && (this.previouslyPlaying = !0),
            this.pause(),
    ...
    handleStickyScroll(e) {
      ...
      if (
        this.isAdmin ||
        this.mutedPreview ||
        !(null === (i = null == this ? void 0 : this.player) || void 0 === i
          ? void 0
          : i.playing)
      )
      ...
      if (
        ((this.isSticky = r.height < -r.top),
        "visible" === document.visibilityState && this.isSticky && this.player)
      ) {
        const e = () => {
          window.removeEventListener("scroll", e),
            this.player.paused && (this.isSticky = !1);
        };
    ...
    handleVisibilityPlayChange(e) {
      ...
      if (
        !this.isAdmin &&
        (null === (t = this.preset) || void 0 === t
          ? void 0
          : t.play_video_viewport) &&
        (!this.player &&
          this.originalConfig.autoplay &&
          ((this.previouslyPlaying = !0),
          (this.autoplay = !!(null == e ? void 0 : e.isIntersecting))),
        this.player)
      ) {
        if (null == e ? void 0 : e.isIntersecting)
          return (
            this.originalConfig.autoplay && (this.autoplay = !0),
            this.previouslyPlaying && this.play(),
            void (this.previouslyPlaying = !1)
          );
    ...
    renderMutedOverlay() {
      ...
      if (this.player && this.mutedPreview && !this.isAdmin)
        return i("presto-muted-overlay", {
          mutedOverlay:
            null === (e = this.player.config.blockAttributes) || void 0 === e
              ? void 0
              : e.mutedOverlay,
          preset: this.preset,
          onPlayVideo: () => {
      ...
      switch (this.provider) {
        ...
        case "bunny":
          return i("presto-bunny", {
            thumbnail:
              null === (e = null == this ? void 0 : this.bunny) || void 0 === e
                ? void 0
                : e.thumbnail,
            getRef: (e) => (this.playerEl = e),
            player: this.player,
    ...
    renderVideoCTA() {
      ...
      (null ===
        ...
        (this.isAdmin ||
          ((null ===
            (i = null === (t = this.preset) || void 0 === t ? void 0 : t.cta) ||
          void 0 === i
            ? void 0
            : i.enabled) &&
            ((null === (r = this.components.cta) || void 0 === r
              ? void 0
              : r.offsetParent) ||
              ("audio" !== this.provider &&
                ((this.components.cta =
                  document.createElement("presto-cta-overlay")),
    ...
    renderAudioCTA() {
      ...
      if (
        ...
        this.player &&
        (null ===
          (t = null === (e = this.preset) || void 0 === e ? void 0 : e.cta) ||
        void 0 === t
          ? void 0
          : t.enabled)
      )
        return i("presto-cta-overlay", {
    ...
    renderEmailOverlay() {
      ...
      !(null ===
        ...
        (null ===
          ...
          ? void 0
          : t.logged_in) ||
        (null === (i = this.components.email) || void 0 === i
          ? void 0
          : i.offsetParent) ||
        ("audio" !== this.provider &&
          ((this.components.email = document.createElement(
      ...
      if (
        (null ===
          (t =
            null === (e = this.preset) || void 0 === e
              ? void 0
              : e.action_bar) || void 0 === t
          ? void 0
          : t.enabled) &&
        this.player
      )
        return i("presto-action-bar", {
    ...
    renderSearchBar() {
      var e, t;
      (null ===
        (t = null === (e = this.preset) || void 0 === e ? void 0 : e.search) ||
      void 0 === t
        ? void 0
        : t.enabled) &&
    ...
    stickyPositionClass() {
      ...
      return this.isSticky
        ? (
            null === (e = this.preset) || void 0 === e
              ? void 0
              : e.sticky_scroll_position
          )
          ? `presto-sticky--${
              null === (t = this.preset) || void 0 === t
                ? void 0
                : t.sticky_scroll_position.replace(/\s+/g, "-")
            }`
          : "presto-sticky--bottom-right"
        : "";
    }
    renderDynamicOverlays() {
      var e, t, i, r, s, o, a;
      this.player &&
        ((null === (e = null == this ? void 0 : this.overlaysComponent) ||
        void 0 === e
          ? void 0
          : e.offsetParent) ||
          ((this.overlaysComponent = document.createElement(
        ...
        (this.overlaysComponent.style.cssText =
        ...
        (this.overlaysComponent.enabled = !(null ===
          (r =
            null ===
              (i =
          ...
          ? void 0
          : r.enabled)),
        (null === (s = null == this ? void 0 : this.overlaysComponent) ||
        void 0 === s
          ? void 0
          : s.offsetParent) ||
          null ===
            (a =
              null === (o = this.player.elements) || void 0 === o
                ? void 0
                : o.wrapper) ||
          void 0 === a ||
          a.append(this.overlaysComponent));
    }
        ...
        i(
          "div",
          {
            ...
            class: `presto-player__wrapper fitvidsignore\n          presto-video-id-${
              ...
              !!(null === (s = this.preset) || void 0 === s
                ? void 0
                : s.skin) &&
              `skin-${
                null === (o = this.preset) || void 0 === o ? void 0 : o.skin
              }`
            }\n        ${
              (
                null === (a = this.preset) || void 0 === a
                  ? void 0
                  : a.hide_youtube
              )
                ? "hide-youtube-ui"
              ...
              (
                null === (n = this.preset) || void 0 === n
                  ? void 0
                  : n.caption_style
              )
                ? `caption-style-${
                    null === (l = this.preset) || void 0 === l
                      ? void 0
                      : l.caption_style
                  }`
                : ""
              ...
              (null === (p = this.preset) || void 0 === p ? void 0 : p.play) &&
              !this.preset.rewind
                ? "rewind-inactive"
                : ""
            }\n        ${this.classes || ""}`,
      ...
      return i(
        ...
        i(
          ...
          i(
            ...
            this.playing ? i(vt, null) : i(mt, null)
          ),
          i("slot", {
...
const xt =
  ...
  $t = class {
    ...
    handleShow() {
      this.show && !this.isLastItem
        ? (setTimeout(() => {
            this.animating = !0;
          }, 200),
          (this.timeout = setTimeout(() => {
            this.show && this.handleNext();
          }, 1e3 * (this.transitionDuration || 5) + 200)))
        : (this.animating = !1);
    }
    handleRewatch() {
      this.rewatch.emit();
    ...
    render() {
      ...
      return i(
        ...
        i(
          ...
          this.isLastItem ? i("p", null, p, ":") : i("p", null, l, ":"),
          i(
            "h2",
            {
              style: {
          ...
          i(
            ...
            i(
              ...
              this.isLastItem
                ? p
                : "Next " +
                    ((null == this ? void 0 : this.nextItemString) || "Video")
            )
          )
        )
      );
...
zt.style = jt;
export { at as P, gt as a, wt as b, $t as c, zt as d, v as r };
